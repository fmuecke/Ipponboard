...
pandoc -s "%BASE_DIR%\manual-en.md" -o "%OUTPUT_DIR%\Manual.html" -T "Ipponboard Manual" --css="%BASE_DIR%\Ipponboard.css" --resource-path="%BASE_DIR%" --self-contained || exit /b %errorlevel%
