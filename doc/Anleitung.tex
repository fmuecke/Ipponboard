...
\newcommand\ps@Standard{
  ...
  \renewcommand\@oddfoot{{\small \textcopyright 2010-{\the\year} Florian Mücke, Stand: \today}\hfill \thepage{}}
...
\begin{figure}[htbp]
	\centering
		\fbox{
		\begin{minipage}{8 cm}
		\includegraphics[width=\textwidth]{images/secondary_view-1-DE.jpg}
		\end{minipage}
		}
		\fbox{
		\begin{minipage}{8 cm}
		\includegraphics[width=\textwidth]{images/secondary_view-2-DE.jpg}
		\end{minipage}
		}
	\caption{Sekundäre Anzeige}
	\label{fig:Secondary_View}
\end{figure}
