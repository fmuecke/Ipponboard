...
cmake -S "%IPPONBOARD_ROOT_DIR%\GamepadDemo" -B "%IPPONBOARD_ROOT_DIR%\_build\build-GamepadDemo" -G "Visual Studio 17 2022" -A Win32 -DUSE_QT5=%USE_QT5% || exit /b %errorlevel%
