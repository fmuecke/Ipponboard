...
void MainWindowTeam::Init()
{
    ...
    if (!Ipponboard::TournamentMode::ReadModes(
            MainWindowTeam::ModeConfigurationFileName(), modes, errMsg))
    {
...
void MainWindowTeam::on_actionManageModes_triggered()
{
    ...
    if (dlg.exec() == QDialog::Accepted)
    {
        ...
        if (!Ipponboard::TournamentMode::WriteModes(
                MainWindowTeam::ModeConfigurationFileName(), dlg.Result(), errMsg))
        {
            QMessageBox::critical(
