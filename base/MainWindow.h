...
class MainWindow : public MainWindowBase
{
  ...
  public:
    ...
    EditionType Edition() const final { return EditionType::Single; }
    const char* EditionName() const final { return "Single Edition"; }
    const char* EditionNameShort() const final { return "Single"; }
  ...
  protected:
    ...
    void write_specific_settings(QSettings& settings) final;
    void read_specific_settings(QSettings& settings) final;
    void update_statebar() override;
