...
char const* const AthleteManager::str_FIRSTNAME = "@FIRSTNAME";
char const* const AthleteManager::str_LASTNAME = "@LASTNAME";
char const* const AthleteManager::str_CLUB = "@CLUB";
char const* const AthleteManager::str_WEIGHT = "@WEIGHT";
char const* const AthleteManager::str_CATEGORY = "@CATEGORY";

const std::array<char const* const, 5> AthleteManager::Specifiers = {
    str_FIRSTNAME, str_LASTNAME, str_CLUB, str_WEIGHT, str_CATEGORY
};

QString AthleteManager::DefaultExportFormat()
{
    QString ret;
...
AthleteManager::AthleteManager() : m_athletes() {}

QString AthleteManager::GetSpecifierDescription()
{
    QString retVal;
...
//bool Ipponboard::AthleteManager::IsValidSpecifier(const QString& str)
//{
//    for(char const * const s : Specifiers)
//    {
//        if (str.compare(s) == 0)
...
bool Ipponboard::AthleteManager::IsFormatSatisfying(const QString& formatStr)
{
...
bool Ipponboard::AthleteManager::DetermineSeparator(const QString& str, QString& sep)
{
