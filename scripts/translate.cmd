...
"%QTDIR%\bin\lupdate" -no-obsolete -locations none -no-recursive -sort-messages %IPPONBOARD_ROOT_DIR%\base %IPPONBOARD_ROOT_DIR%\core %IPPONBOARD_ROOT_DIR%\widgets -ts %IPPONBOARD_ROOT_DIR%\i18n\de.ts -ts %IPPONBOARD_ROOT_DIR%\i18n\nl.ts
